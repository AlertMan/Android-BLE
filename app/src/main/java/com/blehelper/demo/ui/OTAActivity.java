...
public class OTAActivity extends AppCompatActivity {
    ...
    private void initView() {
        tvOta = (TextView)findViewById(R.id.tvOta);
        tvOta.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void updateOta() {
        if(ble == null){
            Utils.showToast("请先初始化ble");
        }
        if(ble.getConnetedDevices().isEmpty()){
            Utils.showToast("未连接设备");
        }
...
//        SystemClock.sleep(200);
        ...
        OtaManager mOtaManager = new OtaManager(OTAActivity.this);
